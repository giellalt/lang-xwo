...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_xwo to login script."
...
# the current dir:
if   test x${GTLANG_xwo} = x ; then
	echo "WARNING: The variable \${GTLANG_xwo} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_xwo} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_xwo} has the value:"
	echo "  ${GTLANG_xwo}"
