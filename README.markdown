...
This directory contains source files for the Written Oirat language
...
-   <https://giellalt.uit.no/lang/xwo/index.html> (analyser)
...
The Written Oirat language sources can be acquired using [giella SVN
